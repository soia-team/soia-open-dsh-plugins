...
export type CheckSkillsFailureCode = 'zstd_unsupported' | 'session_not_found' | 'sessions_dir_missing' | 'sessions_dir_empty' | 'session_unreadable' | 'session_empty' | 'session_decompress_failed';
...
export type SkillVerdict = 'ok' | 'not_in_catalog' | 'not_attempted' | 'wrong_pick' | 'loaded_not_effective' | 'unreported';
