...
import { registerLiveTaskProjection } from './host/live-task-projection.ts'
 ...
 */
export const name = 'ui-live-tasks'
 ...
 */
export function installLiveTasks(ctx: Context): LiveTaskStore {
